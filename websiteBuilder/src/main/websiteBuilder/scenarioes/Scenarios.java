package src.main.websiteBuilder.scenarioes;

import src.main.websiteBuilder.WebsiteBuilder;
import src.main.websiteBuilder.htmlTags.body.*;
import src.main.websiteBuilder.htmlTags.head.Head;
import src.main.websiteBuilder.pages.*;

import java.io.IOException;

import static src.main.websiteBuilder.util.FontFamily.ARIAL;
import static src.main.websiteBuilder.util.FontFamily.TimesNewRoman;
import static src.main.websiteBuilder.util.FontSize.FONTSIZE3;
import static src.main.websiteBuilder.util.FontSize.FONTSIZE4;
import static src.main.websiteBuilder.util.FontWeight.BOLD;
import static src.main.websiteBuilder.util.FontWeight.LIGHT;
