package src.main.websiteBuilder.htmlTags.body;

import src.main.websiteBuilder.util.*;

import static src.main.websiteBuilder.util.FindIndexBeforeTag.findIndexBeforeTag;
import static src.main.websiteBuilder.util.ReplaceWord.replaceAllWords;

/**
 * class for defining and building a main element for a Page {@link src.main.websiteBuilder.pages.Page}
 *
 * @version 1.0.0
 */
public class Main {
