package websiteGenerator.scenarioes;
...
//                .addSocialMediaLinksContainer()
        ...
        Main articleMain = Main.createElementBuilder()
                ...
                .addTxtToHtml("websiteGenerator/scenarioes/Scenario5.txt")
        ...
        Table premiereLeagueTable = Table.createTableBuilder()
                .addCSVToHTMLTable("websiteGenerator/scenarioes/100_Sales_Records.csv", ",")
                .build();
