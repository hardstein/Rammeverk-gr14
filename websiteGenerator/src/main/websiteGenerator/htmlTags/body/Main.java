...
import src.main.websiteGenerator.util.*;

import static src.main.websiteGenerator.util.FindIndexBeforeTag.findIndexBeforeTag;
import static src.main.websiteGenerator.util.ReplaceWord.replaceAllWords;

/**
 * class for defining and building a main element for a Page {@link src.main.websiteGenerator.pages.Page}
 *
 * @version 1.0.0
 */
public class Main {
